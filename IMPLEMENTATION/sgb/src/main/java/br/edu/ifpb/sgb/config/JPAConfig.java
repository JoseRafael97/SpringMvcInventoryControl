package br.edu.ifpb.sgb.config;
...
import br.edu.ifpb.sgb.repository.Products;

@Configuration
@EnableJpaRepositories(basePackageClasses = Products.class)
public class JPAConfig {
	...
	public DataSource dataSource(){
		...
		return dataSourceLookup.getDataSource("jdbc/sgestDB");
	}
